...
public class Waits extends BaseTest {
    ...
    public void testExplicitWait(){
        ...
        wait.until(ExpectedConditions.elementToBeClickable(enableAfter)).click(); //ждет пока этот элемент будет кликнут
    ...
    @Test
    public void etsySingIn(){
        driver.navigate().to("http://www.com/");

        WebElement singInBtn = driver.findElement(By.id("/button[contains(text(),'Sing in')]"));
        singInBtn.click();
